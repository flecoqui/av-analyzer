...
#rtspextract -f -i rtsp://acipoc2231.eastus2.azurecontainer.io:554/media/camera-300s.mp4 -e 25 -o /tmp/frame-%s.jpg
...
#/opt/ffmpeg/bin/ffmpeg -rtsp_transport tcp   -r 25 -i rtsp://acipoc2231.eastus2.azurecontainer.io:554/media/sfence2.mp4 -vf fps=1  -strftime 1  /tmp/frame_%018.6f.jpg
#/opt/ffmpeg/bin/ffmpeg -rtsp_transport tcp   -r 25 -i rtsp://acipoc2231.eastus2.azurecontainer.io:554/media/sfence2.mp4 -acodec copy -f segment -segment_time 10  -vcodec copy  -copyts -strftime 1  /tmp/chunk_%018.6f.mp4
